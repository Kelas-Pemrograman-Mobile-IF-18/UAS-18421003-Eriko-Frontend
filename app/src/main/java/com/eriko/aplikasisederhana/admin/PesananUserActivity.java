...
import com.eriko.aplikasisederhana.customer.HomeCustomerActivity;
...
public class PesananUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterTransaksi(PesananUserActivity.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(PesananUserActivity.this, HomeAdminActivity.class);
        startActivity(i);
        finish();
    }
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(PesananUserActivity.this, HomeCustomerActivity.class);
