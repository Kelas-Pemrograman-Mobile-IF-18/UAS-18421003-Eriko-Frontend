...
public class PilihFilmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_film);
        getSupportActionBar().setTitle("Pilih Film");
        ...
        newsList.clear();
        adapter = new AdapterFilm(PilihFilmActivity.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(PilihFilmActivity.this, HomeCustomerActivity.class);
        startActivity(i);
        finish();
    }
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(PilihFilmActivity.this, DetailCustomer.class);
